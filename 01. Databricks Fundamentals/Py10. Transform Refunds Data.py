...
df_refunds = spark.table('ginzobox.bronze.v_refunds')
display(df_refunds)
...
df_split_refunds =df_refunds.select(
                    "refund_id",
                    "payment_id",
                    "refund_timestamp",
                    "refund_amount",
...
df_transformed_refunds.writeTo("ginzobox.silver.py_refunds").createOrReplace()

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM ginzobox.silver.py_refunds;
