...
df_orders = spark.table('ginzobox.silver.py_orders_json')
display(df_orders)
...
df_order_items.writeTo("ginzobox.silver.py_orders").createOrReplace()

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM ginzobox.silver.py_orders;
