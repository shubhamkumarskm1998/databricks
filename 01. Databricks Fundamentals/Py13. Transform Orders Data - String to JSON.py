...
df_orders = spark.table('ginzobox.bronze.py_orders')
display(df_orders)
...
df_json_orders.writeTo("ginzobox.silver.py_orders_json").createOrReplace()

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM ginzobox.silver.py_orders_json;
